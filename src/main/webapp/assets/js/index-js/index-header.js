...
=======
	    ...
	    console.log(deli.isLoggedIn());
>>>>>>> c3d1d64b16c3cd852c0a6ed5b3ffacafe97bfb9a
		if(deli.isLoggedIn()===false){
            ...
            if(deli.getUserRole()=="SELLER"){
                s +="<ul class='navbar-login'>";
<<<<<<< HEAD
            s +="<li><i id='mypagebtn' onclick='mypage();'>"+deli.getUserEmail()+"(SELLER)님</i></li>";
=======
...
>>>>>>> c3d1d64b16c3cd852c0a6ed5b3ffacafe97bfb9a
            ...
            s +="<ul class='navbar-login'>";
<<<<<<< HEAD
            s +="<li><i id='mypagebtn' onclick='mypage();'>"+deli.getUserEmail()+"(CLIENT)님</i></li>";
=======
